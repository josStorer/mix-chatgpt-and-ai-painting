...
def init():
    global last_msg_id_of_user, image_gen_messages, is_remote_machine, banned_user_id, is_gpu_connected, ws, gpu_connect_confirm_timer, auth_vip_id, use_chatgpt, chat_history, user_needat
    last_msg_id_of_user = {}
    image_gen_messages = []
